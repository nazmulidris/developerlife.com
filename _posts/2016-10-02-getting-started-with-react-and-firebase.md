...
The project uses the Node event emitter to tie observers to observables. It all begins with this
import:
...
I chose to use Typescript for parts of this project (the container classes) in order to leverage the
