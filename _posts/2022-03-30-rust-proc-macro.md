...
- [Example of a simple function-like macro that dumps the AST](#example-of-a-simple-function-like-macro-that-dumps-the-ast)
- [Example of a complex function-like macro that parses custom syntax](#example-of-a-complex-function-like-macro-that-parses-custom-syntax)
...
- [Example of a simple derive macro that adds a method to a struct](#example-of-a-simple-derive-macro-that-adds-a-method-to-a-struct)
...
- [Example of a complex derive macro that generates a builder](#example-of-a-complex-derive-macro-that-generates-a-builder)
- [Example of a simple attribute procedural macro that adds logging to a function](#example-of-a-simple-attribute-procedural-macro-that-adds-logging-to-a-function)
...
## Example of a simple attribute procedural macro that adds logging to a function
