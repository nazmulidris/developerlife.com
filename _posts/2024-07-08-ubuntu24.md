...
The scripts can be run in the following order. Really the only one that is required to be
run first is the
[`0-bootstrap.bash`](https://github.com/nazmulidris/rust-scratch/blob/main/ubuntu24/0-bootstrap.bash)
script. The rest can be run in any order.
